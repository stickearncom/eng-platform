...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-[1.1rem] border border-border/80 bg-card/96 shadow-panel backdrop-blur-md transition-shadow duration-200 hover:shadow-[0_16px_40px_-24px_rgba(24,39,75,0.16)]',
        className,
      )}
      {...props}
    />
